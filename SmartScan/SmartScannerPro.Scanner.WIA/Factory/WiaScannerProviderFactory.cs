...
/// <summary>
/// Implements <see cref="IScannerProviderFactory"/> for the Windows Image Acquisition (WIA) provider.
/// Handles all hardware identifiers that are not prefixed with a known non-WIA prefix.
/// Uses late-bound dynamic COM calls to eliminate compile-time dependencies on MSBuild COM resolution.
/// </summary>
public sealed class WiaScannerProviderFactory : IScannerProviderFactory
{
    /// <inheritdoc/>
    public string ProviderName => "WIA";
